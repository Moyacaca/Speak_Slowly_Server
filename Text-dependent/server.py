...
firebase_admin.initialize_app(cred,{'storageBucket': 'cgh-rcnn-flask.appspot.com'}) # connecting to firebase
...
def extract_name(filename):
    ...
    download_blob(firebase_admin.storage.bucket().name, save_path+"/"+filename, 'data_0820word/'+filename)
    ...
    consonants =["p", "ph", "m", "f", "t", "th", "n", "l", "x", "tɕ", "thɕ", "ɕ", "tʂ", "thʂ", "ʂ", "ʐ", "ts", "tsh", "s", "k", "kh"]
    ...
    for consonant_error_type in consonant_error_types:
        ...
        # re_str = re_str+chinese_dict[consonant_error_type]+' : '+str(pen)+'\n'
    ...
    # print(f"FCDP :{FCDP_number/total_vowel}")
    # print(f"total_consonant:{total_consonant}")
    # re_str = re_str+"聲隨孕母: "+str(round(FCDP_number/total_vowel,2)) +'\n'   
    # print(f"PCC : {1 - PCC_error/total_consonant}")
    # re_str = re_str+"其他: "+str(others/(total_consonant+total_vowel))+'\n'
    # re_str = re_str+"子音正確率: "+str(round(1 - PCC_error/total_consonant,2))+'\n'
    # re_str = re_str+"insert: "+str(insert)+'\n'
    # re_str = re_str+"delete: "+str(delete)+'\n'
    # re_str = re_str+"sub: "+str(sub)+'\n'
    # re_str = re_str+"cor: "+str(cor)+'\n'
    # re_str = re_str+"sum: "+str(count)+'\n'
    # hyps.sort()
    #看有沒有要看結果
    # for hyp in hyps:
    #     re_str = re_str+hyp+'\n'
