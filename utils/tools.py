...
common_incorrect_voc = {'t': ['r', 'l', 'n', 'ah', 'z', 'uw', 'dh', 's', 'th', 'f', 'sh', 'p', 'ch', 'ae', 'd', 'eh', 'k', 'sil', 'er', 'v'], 'ah': ['l', 'z', 'uw', 'uh', 'ao', 'ay', 'ih', 'ae', 'aa', 'd', 'eh', 'ow', 'iy', 'sil', 'ey', 'aw', 'er', 't', 'b'], 'v': ['k', 'r', 'w', 'sil', 'l', 's', 'p', 'f', 'er', 'b'], 'iy': ['jh', 'sil', 'er', 'ah', 'ey', 'uw', 'ay', 'ih', 'aw', 'y', 'eh', 'ow'], 'l': ['r', 'w', 'sil', 'n', 'iy', 'ah', 'z', 'f', 'ih', 'er', 't', 'eh'], 'r': ['w', 'sil', 'l', 'n', 'uh', 'iy', 'ah', 'ao', 'z', 'ey', 'aa', 'ih', 'er', 'd'], 'sil': ['r', 'l', 'n', 'ah', 'z', 'uw', 'dh', 'w', 's', 'uh', 'ao', 'f', 'sh', 'ih', 'm', 'y', 'jh', 'p', 'ae', 'aa', 'ng', 'd', 'eh', 'k', 'iy', 'hh', 'g', 'er', 'v', 't', 'b'], 'dh': ['r', 'hh', 'sil', 'l', 's', 'n', 'th', 'p', 'z', 'y', 'er', 'd', 't', 'eh'], 'ae': ['sil', 'ao', 'ah', 'ey', 'ay', 'aa', 'ih', 'aw', 't', 'eh'], 'ow': ['iy', 'r', 'sil', 'w', 'uh', 'ao', 'ah', 'uw', 'aa', 'ih', 'oy', 'aw', 'er'], 'p': ['k', 'sil', 'f', 'er', 'v', 't', 'b'], 'er': ['iy', 'r', 'sil', 'l', 'w', 'uh', 'ao', 'ah', 'uw', 'aa', 'eh', 'ow'], 'd': ['r', 'l', 'n', 'ah', 'z', 'dh', 's', 'zh', 'th', 'f', 'jh', 'p', 'ng', 'eh', 'k', 'iy', 'sil', 'g', 'er', 'v', 't', 'b'], 'ch': ['jh', 'sil', 'zh', 's', 'dh', 'sh', 't'], 'ih': ['iy', 'r', 'sil', 'n', 'uh', 'ah', 'ey', 'ae', 'ay', 'aa', 'uw', 'er', 'eh'], 's': ['k', 'hh', 'sil', 'zh', 'th', 'z', 'sh', 't'], 'z': ['r', 'jh', 'sil', 's', 'zh', 'g', 'th', 'f', 'dh', 'sh', 'er', 't'], 'aa': ['sil', 'ao', 'ah', 'ae', 'uw', 'aw', 'er', 'eh', 'ow'], 'g': ['k', 'jh', 'hh', 'sil', 'er', 'd', 'b'], 'ng': ['sil', 'n', 'l', 'uh', 'm'], 'n': ['hh', 'sil', 'l', 'p', 'z', 'f', 'ng', 'm', 'y', 'v', 'd'], 'hh': ['k', 'jh', 'sil', 'g', 'er', 'ch', 'sh', 'y', 't'], 'jh': ['k', 'sil', 'zh', 's', 'g', 'ch', 'sh', 'y', 'er', 'd', 't'], 'uh': ['ao', 'ah', 'uw', 'ih', 'er', 'ow'], 'eh': ['iy', 'r', 'sil', 'ah', 'ey', 'ae', 'ay', 'aa', 'uw', 'ih', 'er', 'ow'], 'uw': ['iy', 'w', 'sil', 'l', 'uh', 'ah', 'ao', 'aa', 'ih', 'oy', 'ow'], 'ey': ['iy', 'sil', 'ah', 'ae', 'ay', 'aa', 'ih', 'eh'], 'b': ['r', 'sil', 'ah', 'p', 'f', 'v', 't'], 'k': ['hh', 'w', 'sil', 's', 'g', 'ch', 'dh', 'er', 't'], 'aw': ['uh', 'ao', 'ah', 'ay', 'aa', 'ow'], 'ay': ['iy', 'r', 'sil', 'ah', 'ey', 'ae', 'aa', 'ih', 'oy', 'eh'], 'sh': ['sil', 'zh', 's', 'ch', 't'], 'zh': ['jh', 's', 'z', 'ch', 'sh'], 'y': ['jh', 'iy', 'sil', 'ih', 'er'], 'f': ['sil', 'p', 'er', 'v', 'b'], 'th': ['sil', 's', 'p', 'z', 'ch', 'f', 'er', 'd', 't'], 'ao': ['sil', 'l', 'uh', 'ah', 'uw', 'ae', 'aa', 'aw', 'er', 'eh', 'ow'], 'm': ['ng', 'sil', 'n'], 'w': ['hh', 'sil', 'l', 'g', 'r', 'ao', 'y', 'v'], 'oy': ['ao', 'ow', 'ay']}

vowels = ['iy', 'aa', 'ae', 'eh', 'ah', 'ao', 'ih', 'ey', 'aw', 'ay', 'er', 'uw', 'uh', 'oy', 'ow']
consonants = ['w', 'dh', 'y', 'hh', 'ch', 'jh', 'th', 'zh', 'd', 'ng', 'b', 'g', 'f', 'k', 'm', 'l', 'n', 's', 'r', 't', 'v', 'z', 'p', 'sh']

index2word = {0: 'blank', 1: '<unk>', 2: 'sil', 3: 'ah', 4: 's', 5: 'uw', 6: 'm', 7: 'f', 8: 'ao', 9: 'r', 10: 'ih', 11: 'z', 12: 'ae', 13: 'p', 14: 'uh', 15: 'l', 16: 'ch', 17: 'ey', 18: 'sh', 19: 'n', 20: 'w', 21: 'eh', 22: 'er', 23: 'aa', 24: 'hh', 25: 'k', 26: 'iy', 27: 'ng', 28: 'd', 29: 'dh', 30: 'aw', 31: 'ay', 32: 'v', 33: 'ow', 34: 'b', 35: 'th', 36: 'g', 37: 'y', 38: 'jh', 39: 't', 40: 'oy', 41: 'zh'}

word2index = {'blank': 0, '<unk>': 1, 'sil': 2, 'ah': 3, 's': 4, 'uw': 5, 'm': 6, 'f': 7, 'ao': 8, 'r': 9, 'ih': 10, 'z': 11, 'ae': 12, 'p': 13, 'uh': 14, 'l': 15, 'ch': 16, 'ey': 17, 'sh': 18, 'n': 19, 'w': 20, 'eh': 21, 'er': 22, 'aa': 23, 'hh': 24, 'k': 25, 'iy': 26, 'ng': 27, 'd': 28, 'dh': 29, 'aw': 30, 'ay': 31, 'v': 32, 'ow': 33, 'b': 34, 'th': 35, 'g': 36, 'y': 37, 'jh': 38, 't': 39, 'oy': 40, 'zh': 41}
